...
class Anonymizer:
    ...
    # Useful when multiple originals collapse to one placeholder ("mts",
    # "MTS", "МТС" → "Acme") and the desired user-facing form is a single
    # canonical variant (e.g., Russian uppercase "МТС").
