# Milestone Archive: v1.0 milestone
...
Plans:
- [x] 08-01-PLAN.md - Add shared secret-lint registry and migrate sanitizer/source warning code.
- [x] 08-02-PLAN.md - Add runner environment allowlist contract and wire agent subprocess envs.
- [x] 08-03-PLAN.md - Wire secret guard audits, redact verification details, and update residual-risk evidence.
- [x] 08-04-PLAN.md - Close Ruff formatting and validation-report gaps.
...
Plans:
- [x] 09-01: Add profile-native verification metadata.
- [x] 09-02: Persist plan verification metadata and include it in transport.
- [x] 09-03: Wire source-aware verification runtime behavior.
- [x] 09-04: Wire remote verification transport and worker execution.
...
Plans:
- [x] 10-01-PLAN.md - Add rollback typed models, Git adapter, service logic, and unit tests.
- [x] 10-02-PLAN.md - Add `whilly rollback` CLI surface, lazy dispatch, and CLI integration tests.
- [x] 10-03-PLAN.md - Wire PR push preflight and update rollback compliance evidence/tests.
...
Plans:
- [x] 11-01-PLAN.md - Add CI polling primitives and `source="ci"` verification dispatch.
- [x] 11-02-PLAN.md - Add bounded repair policy, events, and deterministic repair task primitives.
- [x] 11-03-PLAN.md - Preserve CI/repair metadata and generate executable ci_status verification commands.
- [x] 11-04-PLAN.md - Wire local CI evidence, repair task insertion, and repair completion events.
- [x] 11-05-PLAN.md - Wire remote transport, remote CI evidence, and bounded repair runtime.
- [x] 11-06-PLAN.md - Add scoped compliance wording and report tests.
