...
result: passed — `whilly jira smoke --issue DEMO-9855` vs jira.example.com (Server/DC 9.12): 6/6 checks, exit 0, report whilly_logs/smoke/jira-smoke-2026-06-12T05:09:27Z.json. Required JIRA_AUTH_SCHEME=bearer + JIRA_API_VERSION=2 (documented in Whilly-Usage.md).
...
result: passed — `whilly gitlab smoke --repo-url https://gitlab.example.com/qa-team/qa-team-core`: 3/3 checks, exit 0, measured durations (auth 1.098s, project_access 1.027s), report persisted.
