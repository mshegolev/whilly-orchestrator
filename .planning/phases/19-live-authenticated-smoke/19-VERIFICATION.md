...
Live Jira smoke 6/6 vs jira.example.com (Server/DC; JIRA_AUTH_SCHEME=bearer, JIRA_API_VERSION=2);
live GitLab smoke 3/3 vs gitlab.example.com; failure-path hints and no-token-leak confirmed.
