...
| WR-04 | fixed | 0c14968 | hardcoded `gitlab.services.mts.ru` removed; glab fallback host derived from resolved `GITLAB_URL`; no host → glab skipped, config gate exits 2 |
