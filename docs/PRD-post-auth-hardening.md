...
**Goal:** Make the MTS↔Acme redaction proxy independently usable by teams outside the Whilly project.

**Scope:** Create `mshegolev/claude-anonymizer` GitHub repository from `/opt/develop/aiqa/claude-anonymizer/`. Add `README.md`, `LICENSE` (MIT), and link from `whilly/docs/anonymizer-usage.md` (update the existing file at `docs/anonymizer-usage.md`).
