"""PRD & Task Plan generator for Ralph orchestrator.
...
На вход — PRD документ. Создай JSON файл с задачами для ralph.py orchestrator.
...
def _call_claude(prompt: str, model: str) -> str:
    ...
    Timeout настраивается через RALPH_CLAUDE_TIMEOUT (default 1800s / 30 мин).
    """
    ...
    timeout = int(os.environ.get("RALPH_CLAUDE_TIMEOUT", "1800"))
