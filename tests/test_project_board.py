...
# NOTE: the legacy ``_finalise_project_board`` post-merge helper has been
# removed in TASK-107. Its v4 replacement is owned by a different surface
# (TASK-108 Forge integration) and tested there.
