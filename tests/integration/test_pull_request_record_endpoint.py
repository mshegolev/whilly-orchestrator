...
def _record_body(
    *,
    task_id: str = _TASK_ID,
    pr_url: str = "https://gitlab.example.com/aiqa/e2e/-/merge_requests/7",
...
async def test_record_pull_request_201_inserts_row_and_emits_event(
    ...
    assert body["pr_url"] == "https://gitlab.example.com/aiqa/e2e/-/merge_requests/7"
    ...
    assert pr["pr_url"] == "https://gitlab.example.com/aiqa/e2e/-/merge_requests/7"
    ...
    assert payload["pr_url"] == "https://gitlab.example.com/aiqa/e2e/-/merge_requests/7"
...
async def test_record_pull_request_idempotent_second_post_returns_200(
    ...
    second_body["pr_url"] = "https://gitlab.example.com/aiqa/e2e/-/merge_requests/99"
