...
log = logging.getLogger("ralph.prd_launcher")
...
def run_prd_wizard(
    ...
    debug_copy = Path("/tmp/ralph_prd_system_prompt.md")
    ...
    print("→ Когда закончишь — /exit или Ctrl+D. Ralph продолжит генерацию tasks.json.")
    print()
    ...
    if generate_tasks_after:
        ...
        try:
            ...
            print(f"   PRD сохранён, запусти позже: ralph.py --tasks-from {prd_path}")
